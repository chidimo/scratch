      ...
      <div className="min-h-screen bg-gradient-to-b from-brand-50 via-white to-white flex flex-col">
        <div className="flex-1 flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl shadow-brand-900/5 ring-1 ring-brand-900/5 px-8 py-10 sm:px-10">
              <div className="text-center mb-8">
                <img
                  src="/scratch-icon.png"
                  alt="Scratch (Gists) logo"
                  className="w-16 h-16 md:w-20 md:h-20 rounded-xl mx-auto mb-6 shadow-md shadow-brand-900/20"
                />
                <h2 className="text-2xl md:text-3xl font-bold text-brand-900 mb-2">
                  {title}
                </h2>
                <p className="text-base text-brand-500 mb-1">
              ...
              <button
                ...
                className="w-full bg-brand-500 hover:bg-brand-600 text-white font-medium py-3 px-4 rounded-lg shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-2"
              >
                {authLoading ? (
                  <>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col items-center gap-1.5">
                      {[{
                        ...
                        <a key={item.name} href={item.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-brand-500 hover:text-brand-600 font-medium text-sm transition-colors">
