      ...
      <div className="min-h-screen bg-brand-800 flex flex-col">
        <div className="flex-1 flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-sm flex flex-col items-center text-center">
            <div className="w-32 h-32 rounded-3xl bg-white/10 flex items-center justify-center mb-7">
              <img
            ...
            <p className="text-lg text-white/75 mb-7 max-w-xs">
              Your ideas, everywhere. Synced straight to GitHub Gists.
            </p>

            <div className="flex items-center gap-2 mb-10">
              {ACCENT_DOTS.map((cls) => (
                <span key={cls} className={`w-2 h-2 rounded-full ${cls}`} />
              ))}
            </div>
            ...
            <button
              ...
              className="w-full bg-white hover:bg-white/90 text-brand-800 font-semibold py-4 px-4 rounded-2xl shadow-xl shadow-black/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-800"
            >
              {authLoading ? (
                <>
            ...
            <div className="mt-10 pt-6 border-t border-white/10 w-full">
              <div className="text-center text-sm text-white/60 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col items-center gap-1.5">
                    {[
                      {
                        name: 'On the web',
                        url: 'https://scratch.chidiorji.com',
                      },
                      {
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1 text-white/80 hover:text-white font-medium text-sm transition-colors"
                      >
