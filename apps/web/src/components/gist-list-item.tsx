...
export const GistListItem = ({ gist }: Props) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white rounded-2xl shadow-md ring-1 ring-brand-900/5 overflow-hidden hover:shadow-lg transition-all duration-200">
      <span className={`block h-1.5 w-full ${accentClassForId(gist.id)}`} />
